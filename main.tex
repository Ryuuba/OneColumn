...
%-------------------------------------------------------------------------------
\title{
   \blue{\textbf{Título del reporte no muy largo}}\\[-0.25cm] % Title
   \gray{\large Nombre de la UEA}\\ % Subtitle
}
...
\lstinputlisting[caption={Implementación del algoritmo recursivo del cálculo del factorial de $x$ en c++.}, label=code:factorial, numbers=left]{code/factorial.cc}
